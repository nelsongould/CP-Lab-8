...
#Graphs, full extend
brks_hotspotssp <- seq(0,3, length.out = 4)
hotspots_sp_cols <- c("white","lightblue","firebrick3")

plot(pol_ship_combo, col = hotspots_sp_cols, legend = F, main  = "Top 20 Shipping and Pollution Threats")
map('world', fill = T, add = T) #this isn't working 



plot(hotspots_sp, col = hotspots_sp_cols, legend = F, main  = "Hotspots Based on Shipping and Pollution Threats")
map('world', fill = T, add = T) #this isn't working 
...
plot(pol_ship_combo, col = hotspots_sp_cols, ext = extent(-121,-117,32,35), legend = F, main  = "Top 20 Shipping and Pollution Threats")
map('world', fill = T, add = T) #this isn't working 
